...
<div class="container">
        ...
        <form action="{{ route('metas.store') }}" class="form-horizontal" method="POST">
         @csrf
        ...
        <div class="notice notice-blue">
            ...
            <strong> Prazo Final:  </strong>  {{  \Carbon\Carbon::parse($ob->data_fim)->format('d/m/Y')   }}<br>
            <strong> Custo Total:  </strong> R${{ number_format($ob->custo_objetivo, 2, ',', '.')}} <br>
        ...
        <div class="form-group row">
            ...
            <div class="form-group col-12 ">
                <label for="comment"><b>Título</b></label>
        ...
        <div class="row">
            ...
            <div class="col-2 form-group">
                ...
                <input value="{{old('custo')}}"  class="form-control money {{ $errors->has('custo') ? 'is-invalid' : '' }}"  type="number" name="custo"  id="custo" >
                @if($errors->has('custo'))
        ...
        <input type="hidden" name="objetivo_id" id="objetivo_id" value={{$ob->objetivo_id}}>
        ...
        <div class="form-row mt-3">
            ...
            onclick="window.location.href='/objetivos/{{$ob->objetivo_id}}'">Cancelar </button>
